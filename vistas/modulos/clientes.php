          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg form-control-lg" name="editarDocumentoId" id="editarDocumentoId" placeholder="Ingresar el Dni"data-inputmask="'mask':'9999999'" data-mask required ="" pattern="[0-9]{8}" readonly><!-- NOvalida-->
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg form-control-lg" name="editarFechaNacimiento" id="editarFechaNacimiento" placeholder="Ingresar fecha nacimiento" pattern="([0-9]{4}\-/[0-9]{2}\-/[0-9]{2})"required>  <!-- Sivalida-->
