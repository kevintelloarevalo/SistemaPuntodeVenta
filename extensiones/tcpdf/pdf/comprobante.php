	...
	<table>
		...
		<tr>
			...
			<td style="background-color:white; width:140px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:px;">
					
					<br>
					Dirección: Calle Gonzales Caceda #454 Pacasmayo
			...
			<td style="background-color:white; width:40px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					<br>
					Teléfono: +51935759008
					
					<br>
					acazycosmetic@gmail.com
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:100px; text-align:center">Valor Unidad.</td>
